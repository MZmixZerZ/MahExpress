...
<body>
    ...
    <div class="row">
    <div class="col-sm-4">
    <div class="h4 text-center alert alert-success  mb-4 mt-4 " role="alert"> เพิ่มข้อมูลผู้ส่ง </div>
    <form method="POST" action="insertsend_placeuser.php">
	<label>รหัสบัตรประชาชน</label>
        <input type="text" name="id1" class="form-control" placeholder="รหัสบัตรประชาชน" required ><br>
	<label>ชื่อ</label>
        <input type="text" name="name1" class="form-control" placeholder="ชื่อ" required ><br>
        <label>นามสกุล</label>
        <input type="text" name="lname1"  class="form-control" placeholder="นามสกุล" required ><br>
        <label>บ้านเลขที่</label>
        <input type="text" name="address1"  class="form-control" placeholder="บ้านเบขที่" required ><br>
        <label>เบอร์โทรศัพท์</label>
        <input type="number" name="phone_number1"  class="form-control" placeholder="เบอร์โทรศัพท์" required ><br>
